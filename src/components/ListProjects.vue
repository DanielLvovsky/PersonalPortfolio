...
<template>
  ...
  <div class="markdown mt-10">
    <p class="opacity-75">
      <em>Thanks for checking out my projects! If you found any of my apps useful, consider<a href="https://www.buymeacoffee.com/daniellvovsky" target="_blank" rel="nofollow noopener noreferrer">&nbsp;supporting me&nbsp;</a>so that I can continue updating the projects with more features. Thanks! :)</em>
    </p>
  </div>
</template>
